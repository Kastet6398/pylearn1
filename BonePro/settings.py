...
EMAIL_HOST_PASSWORD = 'cpjbozbnewszensz'
...
ALLOWED_HOSTS = ['51.20.69.129', 'pylearn.ddns.net', '.vercel.app', 'py-learn.onrender.com']
...
MIDDLEWARE = [
    'BonePro.middleware.MaxConnectionsMiddleware',
